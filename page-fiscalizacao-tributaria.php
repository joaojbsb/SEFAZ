             ...
             <div class="col-sm-12 col-md-6 col-lg-4 my-5">
               ...
               <div class="card border-0">
                  ...
                  <div class="card-body text-center">
                    ...
                    <p><?php echo get_theme_mod('set_telefone_fiscatributaria'); ?></p>
             ...
             <div class="col-sm-12 col-md-6 col-lg-4 my-5">
               ...
               <div class="card border-0">
                  ...
                  <div class="card-body text-center">
                   ...
                   <address><?php echo get_theme_mod('set_endereco_fiscatributaria'); ?> </address>
             ...
             <div class="col-sm-12 col-md-6 col-lg-4 my-5">
               ...
               <div class="card border-0">
                  ...
                  <div class="card-body text-center">
                    ...
                    <p><?php echo get_theme_mod('set_email_fiscatributaria'); ?></p>
